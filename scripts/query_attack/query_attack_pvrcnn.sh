...
# python black_box_attack.py --exp-name query_attack_pvrcnn_pp --learning-rate 0.5 --cfg-file configs/attack_configs/kitti_black_box/pointpillar/query_attack_pvrcnn.yaml
