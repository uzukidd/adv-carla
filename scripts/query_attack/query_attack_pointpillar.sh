...
# python black_box_attack.py --exp-name query_attack_pointpillar_pr --learning-rate 0.05 --cfg-file configs/attack_configs/kitti_black_box/pointrcnn/query_attack_pointpillar.yaml
...
python black_box_attack.py  --device $1 --exp-name query_attack_pointpillar_pv_s1 --surrogate-stage-1 --learning-rate 0.005 --cfg-file configs/attack_configs/kitti_black_box/pvrcnn/query_attack_pointpillar.yaml
