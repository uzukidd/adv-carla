...
python attack.py --exp-name pointrcnn_roihead_attack --roihead-attack --iou-frozen --cfg-file configs/attack_configs/kitti/relevant_bounding_box_pointrcnn.yaml 
