...
python attack.py --headbox-attack --exp-name $1_full_attack --cfg-file configs/attack_configs/relevant_bounding_box_$1.yaml --device $2
python attack.py --headbox-attack --exp-name $1_iou_frozen --iou-frozen --cfg-file configs/attack_configs/relevant_bounding_box_$1.yaml --device $2
python attack.py --headbox-attack --exp-name $1_logit_frozen --logit-frozen --cfg-file configs/attack_configs/relevant_bounding_box_$1.yaml --device $2
