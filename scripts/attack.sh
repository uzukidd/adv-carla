...
python attack.py --exp-name $1_headbox_iou_frozen --optim ifgsm --headbox-attack --iou-frozen --cfg-file configs/attack_configs/kitti/relevant_bounding_box_$1.yaml --device $2
