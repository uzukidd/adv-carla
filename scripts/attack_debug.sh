...
python attack.py --exp-name pointrcn_0 --mode 0 --cfg-file configs/attack_configs/kitti/relevant_bounding_box_pointrcnn.yaml 
python attack.py --exp-name pointrcn_1 --mode 1 --cfg-file configs/attack_configs/kitti/relevant_bounding_box_pointrcnn.yaml 
python attack.py --exp-name pointrcn_2 --mode 2 --cfg-file configs/attack_configs/kitti/relevant_bounding_box_pointrcnn.yaml 
python attack.py --exp-name pointrcn_3 --mode 3 --cfg-file configs/attack_configs/kitti/relevant_bounding_box_pointrcnn.yaml 
