...
python attack.py --exp-name pointrcnn_roihead_attack --roihead-attack --roi-head-weights 0.75 --cfg-file configs/attack_configs/kitti/relevant_bounding_box_pointrcnn.yaml 
