...
python attack.py --exp-name scale_ablation/$1_eval_init_patch_$3_$4_$5 --eval-init-patch --scale $3 $4 $5 --cfg-file configs/attack_configs/relevant_bounding_box_$1.yaml --device $2