...
rm -rf output/train/scale_ablation/$1_misrecognize_10_$3_$4_$5
...
python main.py --exp-name scale_ablation/$1_misrecognize_10_$3_$4_$5 --scale $3 $4 $5 --learning-rate $6 --roihead-attack --iou-frozen --stage-2-loss-reduce-func logit_multiply_iou3d --cfg-file configs/attack_configs/kitti/relevant_bounding_box_$1.yaml --device $2
